...
public class PurchaseItemController extends BaseController
{
    ...
    // 查询列表
    @PreAuthorize("@ss.hasPermi('system:purchaseItem:list')") // 👈 小写 p
    @GetMapping("/list")
    ...
    // 导出
    @PreAuthorize("@ss.hasPermi('system:purchaseItem:export')") // 👈 小写 p
    ...
    // 详情
    @PreAuthorize("@ss.hasPermi('system:purchaseItem:query')") // 👈 小写 p
    @GetMapping(value = "/{id}")
    ...
    // 新增
    @PreAuthorize("@ss.hasPermi('system:purchaseItem:add')") // 👈 小写 p
    ...
    // 修改
    @PreAuthorize("@ss.hasPermi('system:purchaseItem:edit')") // 👈 小写 p
    ...
    // 删除
    @PreAuthorize("@ss.hasPermi('system:purchaseItem:remove')") // 👈 小写 p
