  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="预警数量" prop="warnQuantity">
        <el-input
          v-model="queryParams.warnQuantity"
          placeholder="请输入预警数量"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="infoList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="产品类型" align="center" prop="productName" />
      <el-table-column label="规格" align="center" prop="productSpec" />
      <el-table-column label="当前库存" align="center" prop="stockQuantity" />
      <el-table-column label="预警数量" align="center" prop="warnQuantity" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="当前库存" prop="stockQuantity">
          <el-input v-model="form.stockQuantity" placeholder="请输入当前库存" />
        </el-form-item>
        <el-form-item label="预警数量" prop="warnQuantity">
          <el-input v-model="form.warnQuantity" placeholder="请输入预警数量" />
        </el-form-item>
      </el-form>
